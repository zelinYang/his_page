layui.define(['jquery', 'laytpl', 'layer'], function (e) {
    "use strict";
    layui.link('../resource/layuiadmin/style/autocomplete.css');
    var hint = layui.hint(),
        $ = layui.jquery,
        laytpl = layui.laytpl,
        layer = layui.layer,
    ...
    job.prototype.pullData = function () {
        ...
        var params = (_config.params ? _config.params : {keywords: _config.filter});
        if (_config.searchField) {
            params[_config.searchField] = _config.filter;
        }
