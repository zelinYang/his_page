...
vjs.Button.prototype.createEl = function(type, props){
  ...
  props = vjs.obj.merge({
    ...
    role: 'button',
    'aria-live': 'polite', // var the screen reader user know that the text of the button may change
    tabIndex: 0
  }, props);
...
vjs.SeekBar.prototype.onMouseMove = function(event){
  ...
  // Don't var video end while scrubbing.
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // report activity on the other events, but won't var them bubble for
...
// Pause to var the DOM keep processing
